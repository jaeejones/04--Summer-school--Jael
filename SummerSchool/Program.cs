// this code works, but I no where near what we corrected in class. Hopefully my progress will count for something
using System;
...
/* I like to possiblities of this code, so I want to save it. It does not run at all
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                Console.WriteLine("2. Student unenrollment");
                Console.WriteLine("3. Roster of Enrolled students");
                Console.WriteLine("4. Special Class");
